        ...
        <div className="container" style={{ paddingTop: '20px', paddingBottom: '50px' }}>
          <div className="row" style={{ marginBottom: "20px" }}>
            <div className="col-lg-12 col-sm-10">
              ...
              <a className="btn btn-info guide" href="https://students.iitgn.ac.in/student-academic-council/P_F_Calculator_Guide.pdf" target="_">Pass Pail Calculator Guide</a>
            </div>
          </div>
