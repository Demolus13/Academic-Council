...
import { members20 } from '../utilities/councilData'
import { Link } from "react-router-dom";

export default function Council20() {
  return (
    <>
    {/* council Section */}
    <div id="council">
      <h1 className="h-bold">Student Academic Council 2020-2021</h1>
      <div className="members">
      {members20.map((cards, index) => (
